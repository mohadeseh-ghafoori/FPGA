...
xst -ifn xst.scr
move my_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\my_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc my_dcm_exdes.ucf my_dcm_exdes

echo 'Running map'
map -timing -pr b my_dcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm my_dcm_exdes -w routed.ncd routed.v
cd ..
